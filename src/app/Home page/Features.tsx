  ...
  return (
    <div className="flex flex-col py-28">
      ...
      {calianaFeatures.map((feature, index) => (
        <div
          key={feature.title}
          className={`flex flex-col justify-center lg:flex-row lg:max-w-7xl lg:mx-auto ${index % 2 ? "lg:flex-row-reverse" : ""}`}
        >
          ...
          <div className="flex flex-col px-4 lg:items-start lg:justify-center">
            ...
            <Button className="my-8 bg-blue-400">{feature.buttonText}</Button>
          </div>
        </div>
      ))}
    </div>
